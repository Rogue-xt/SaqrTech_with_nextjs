          ...
          {stackContents.map((item, index) => (
            ...
            >
              <motion.div
                ...
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                className={`relative flex h-auto min-h-[350px] flex-col items-center justify-center rounded-[2.5rem] border border-white/5 p-8 text-center shadow-2xl transition-all duration-500 md:sticky md:min-h-[400px] md:p-16 ${
                  item.theme === "red"
      ...
      <section className="relative flex min-h-[90vh] items-center overflow-hidden px-6 pt-20 md:px-16">
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-12 lg:grid-cols-2">
          <motion.div {...fadeIn}>
            ...
            <p className="mt-8 max-w-xl text-lg leading-relaxed text-gray-400 md:text-xl">
              Tailored strategies to meet the specific needs of various sectors,
              including healthcare, finance, retail, and manufacturing. IT
              infrastructure designed to grow alongside your business,
              accommodating expanding requirements seamlessly. Around-the-clock
              assistance to resolve issues quickly and keep your operations
              running smoothly. A skilled team dedicated to delivering
      ...
      <section>
        ...
        <div className="mx-auto mb-10 max-w-6xl px-10 pb-20 text-center text-lg leading-relaxed text-gray-400 md:text-xl">
          <p>
            ...
            quietly emerged as a hotbed for technology innovation, with a range
            of IT companies revolutionizing the landscape.
          </p>
          <br />
          <p>
            ...
            companies are making their mark in the regional and global markets.
          </p>
          <br />
          <p>
            ...
            of skilled professionals and state-of-the-art infrastructure, these
            IT companies in Sharjah are setting new benchmarks for the industry.
          </p>
          <br />
          <p>
            In this article, we will unveil the top IT companies in Sharjah that
            are at the forefront of technology innovation. Join us as we explore
            their unique offerings, success stories, and the impact they are
            making on the digital landscape. Discover the hidden gems that are
            driving the technology revolution in Sharjah.
          </p>
          <p>
            ...
            mobile app development, cloud computing, and cybersecurity. They are
            known for their innovative solutions, exceptional customer service,
            and ability to tailor their services to meet the unique needs of
            businesses in Sharjah.
          </p>
          <br />
          <p>
            Whether you are a startup looking to establish your online presence,
            or an established business seeking to optimize your IT
            infrastructure, these companies have the expertise and experience to
            exceed your expectations. Join us as we explore the top IT companies
            in Sharjah and discover how they are revolutionizing the digital
            landscape in the heart of the UAE.
          </p>
        </div>
      </section>
    </div>
